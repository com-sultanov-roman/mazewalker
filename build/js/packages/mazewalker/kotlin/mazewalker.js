(function (root, factory) {
  ...
  AutomatonBuildException.prototype = Object.create(Throwable.prototype);
  AutomatonBuildException.prototype.constructor = AutomatonBuildException;
  MoveTool.prototype = Object.create(BaseMouseEventHandler.prototype);
  MoveTool.prototype.constructor = MoveTool;
  ChessMazeEditorCore.prototype = Object.create(ChessMazeGenerator.prototype);
  ChessMazeEditorCore.prototype.constructor = ChessMazeEditorCore;
  function Automaton() {
  }
  ...
  AutomatonBuilder.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'AutomatonBuilder',
    interfaces: []
  };
  function AutomatonBuildException(message, code) {
    Throwable.call(this);
    this.message_dtg7xq$_0 = message;
    this.cause_29mk38$_0 = null;
    this.code = code;
    Kotlin.captureStack(Throwable, this);
    this.name = 'AutomatonBuildException';
  }
  Object.defineProperty(AutomatonBuildException.prototype, 'message', {
    get: function () {
      return this.message_dtg7xq$_0;
    }
  });
  Object.defineProperty(AutomatonBuildException.prototype, 'cause', {
    get: function () {
      return this.cause_29mk38$_0;
    }
  });
  AutomatonBuildException.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'AutomatonBuildException',
  ...
  AutomatonContext.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'AutomatonContext',
    interfaces: [Automaton]
  };
  function AutomatonContextHolder() {
    this.contextMap = LinkedHashMap_init();
  }
  AutomatonContextHolder.prototype.addContext_32vzqj$ = function (name, automatonContext) {
    this.contextMap.put_xwzc9p$(name, automatonContext);
  };
  AutomatonContextHolder.prototype.getContextByName_61zpoe$ = function (name) {
    return this.contextMap.get_11rb$(name);
  };
  AutomatonContextHolder.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'AutomatonContextHolder',
    interfaces: []
  };
  ...
  AutomatonContextManager.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'AutomatonContextManager',
    interfaces: []
  };
  ...
  AutomatonRepository$Companion.$metadata$ = {
    kind: Kind_OBJECT,
  ...
  AutomatonRepository.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'AutomatonRepository',
    interfaces: []
  };
  function DFA() {
  ...
  Object.defineProperty(DFA.prototype, 'stateMap', {
    configurable: true,
    get: function () {
  ...
  DFABuilder.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'DFABuilder',
    interfaces: [Prepare, AutomatonBuilder]
  };
  function Prepare() {
  }
  ...
  BaseMouseEventHandler.prototype.mouseDown_tfvzir$ = function (mouseEvent) {
    this.pressed = true;
    console.log(true);
    this.mouseDownHandler_tfvzir$(mouseEvent);
  };
  BaseMouseEventHandler.prototype.mouseUp_tfvzir$ = function (mouseEvent) {
    this.pressed = false;
    this.mouseUpHandler_tfvzir$(mouseEvent);
  };
  BaseMouseEventHandler.prototype.mouseOver_tfvzir$ = function (mouseEvent) {
    this.over = true;
    this.mouseOverHandler_tfvzir$(mouseEvent);
  };
  BaseMouseEventHandler.prototype.mouseOut_tfvzir$ = function (mouseEvent) {
    this.over = false;
    this.mouseOutHandler_tfvzir$(mouseEvent);
  };
  BaseMouseEventHandler.prototype.mouseMove_tfvzir$ = function (mouseEvent) {
    this.move = true;
    this.mouseMoveHandler_tfvzir$(mouseEvent);
  };
  BaseMouseEventHandler.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'BaseMouseEventHandler',
    interfaces: [Handler]
  };
  function Handler() {
  }
  ...
  function MoveTool(scene) {
    BaseMouseEventHandler.call(this);
    this.scene_0 = scene;
    this.x_0 = 0;
    this.y_0 = 0;
  }
  MoveTool.prototype.mouseDownHandler_tfvzir$ = function (mouseEvent) {
    this.pressed = true;
    this.x_0 = numberToInt(mouseEvent.offsetX);
    this.y_0 = numberToInt(mouseEvent.offsetY);
  };
  MoveTool.prototype.mouseUpHandler_tfvzir$ = function (mouseEvent) {
    this.pressed = false;
  };
  MoveTool.prototype.mouseOverHandler_tfvzir$ = function (mouseEvent) {
    throw new NotImplementedError_init('An operation is not implemented: ' + 'Not yet implemented');
  };
  MoveTool.prototype.mouseOutHandler_tfvzir$ = function (mouseEvent) {
    throw new NotImplementedError_init('An operation is not implemented: ' + 'Not yet implemented');
  };
  MoveTool.prototype.mouseMoveHandler_tfvzir$ = function (mouseEvent) {
    var tmp$, tmp$_0;
    if (this.pressed) {
      var _x = 0;
      var _y = 0;
      tmp$ = this.scene_0;
      tmp$.offsetX = tmp$.offsetX + (_x - this.x_0) | 0;
      tmp$_0 = this.scene_0;
      tmp$_0.offsetY = tmp$_0.offsetY + (_y - this.y_0) | 0;
      console.log(_x - this.x_0 | 0);
      console.log(_y - this.y_0 | 0);
      this.mouseDownHandler_tfvzir$(mouseEvent);
    }};
  MoveTool.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'MoveTool',
    interfaces: [BaseMouseEventHandler]
  };
  function ChessMaze() {
  ...
  Object.defineProperty(ChessMaze.prototype, 'topLeftVertex_0', {
    configurable: true,
    get: function () {
  ...
  Object.defineProperty(ChessMaze.prototype, 'bottomRightVertex_0', {
    configurable: true,
    get: function () {
  ...
  Object.defineProperty(ChessMazeBorder.prototype, 'startVertex', {
    configurable: true,
    get: function () {
  ...
  Object.defineProperty(ChessMazeBorder.prototype, 'endVertex', {
    configurable: true,
    get: function () {
  ...
  Object.defineProperty(ChessMazeBorder.prototype, 'color', {
    configurable: true,
    get: function () {
  ...
  ChessMazeBorder.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ChessMazeBorder',
    interfaces: []
  };
  ...
  function ChessMazeBorder_init_1(vertexX, vertexY, vertexColor, $this) {
    $this = $this || Object.create(ChessMazeBorder.prototype);
    ChessMazeBorder.call($this);
    $this.startVertex = ChessMazeVertex_init(vertexX, vertexY, vertexColor);
    $this.endVertex = ChessMazeVertex_init(vertexX, vertexY, vertexColor);
  ...
  Object.defineProperty(ChessMazeVertex.prototype, 'X', {
    configurable: true,
    get: function () {
  ...
  Object.defineProperty(ChessMazeVertex.prototype, 'Y', {
    configurable: true,
    get: function () {
  ...
  Object.defineProperty(ChessMazeVertex.prototype, 'color', {
    configurable: true,
    get: function () {
  ...
  ChessMazeVertex.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ChessMazeVertex',
    interfaces: []
  };
  ...
  function ChessMazeVertex_init_1($this) {
    $this = $this || Object.create(ChessMazeVertex.prototype);
    ChessMazeVertex.call($this);
    $this.X = 0;
    $this.Y = 0;
  ...
  ChessMazeEditor.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ChessMazeEditor',
    interfaces: []
  };
  ...
  ChessMazeEditorCore$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: []
  };
  ...
  ChessMazeEditorCore.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ChessMazeEditorCore',
    interfaces: [ChessMazeGenerator]
  };
  ...
  ChessMazeGenerator$Companion$evaluateExpression$ObjectLiteral.$metadata$ = {
    kind: Kind_CLASS,
    interfaces: []
  };
  ...
  ChessMazeGenerator$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: []
  };
  ...
  ChessMazeGenerator.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ChessMazeGenerator',
    interfaces: []
  };
  function ChessMazeManager() {
    ChessMazeManager$Companion_getInstance();
  }
  function ChessMazeManager$Companion() {
    ChessMazeManager$Companion_instance = this;
  }
  ChessMazeManager$Companion.prototype.convertToMatrix_93ll4v$ = function (maze) {
    return new ChessMazeMatrix(maze);
  };
  ChessMazeManager$Companion.prototype.getMazeFromMatrix_9w85em$ = function (matrix) {
    var tl = ChessMazeVertex_init(matrix[0][0], matrix[0][1], 0);
  };
  ChessMazeManager$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: []
  };
  var ChessMazeManager$Companion_instance = null;
  function ChessMazeManager$Companion_getInstance() {
    if (ChessMazeManager$Companion_instance === null) {
      new ChessMazeManager$Companion();
    }return ChessMazeManager$Companion_instance;
  }
  ChessMazeManager.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ChessMazeManager',
    interfaces: []
  };
  function ChessMazeMatrix(m) {
    this.maze_0 = m;
    this.rows_0 = abs(this.maze_0.getTopLeftVertex().Y - this.maze_0.getBottomRightVertex().Y | 0) + 3 | 0;
    this.columns_0 = abs(this.maze_0.getTopLeftVertex().X - this.maze_0.getBottomRightVertex().X | 0) + 3 | 0;
    var array = Array_0(this.rows_0);
    var tmp$;
    tmp$ = array.length - 1 | 0;
    for (var i = 0; i <= tmp$; i++) {
      var array_0 = Array_0(this.columns_0);
      var tmp$_0;
    ...
    this.matrix_0 = array;
    this.metadata_0 = LinkedHashMap_init();
    var tmp$_1, tmp$_2;
    var bl = this.maze_0.getVertexByCoordinate_vux9f0$(this.maze_0.getTopLeftVertex().X, this.maze_0.getBottomRightVertex().Y);
    var $receiver = this.metadata_0;
    var key = 'top_left';
    var value = this.maze_0.getTopLeftVertex();
    $receiver.put_xwzc9p$(key, value);
    var $receiver_0 = this.metadata_0;
    var key_0 = 'bottom_right';
    var value_0 = this.maze_0.getBottomRightVertex();
    $receiver_0.put_xwzc9p$(key_0, value_0);
    var $receiver_1 = this.metadata_0;
    var key_1 = 'bottom_left';
    $receiver_1.put_xwzc9p$(key_1, bl);
    var $receiver_2 = this.metadata_0;
    var value_1 = abs(this.maze_0.getTopLeftVertex().Y - this.maze_0.getBottomRightVertex().Y | 0) + 1 | 0;
    $receiver_2.put_xwzc9p$('height', value_1);
    var $receiver_3 = this.metadata_0;
    var value_2 = abs(this.maze_0.getTopLeftVertex().X - this.maze_0.getBottomRightVertex().X | 0) + 1 | 0;
    $receiver_3.put_xwzc9p$('width', value_2);
    var tmp$_3 = this.matrix_0;
    var array_1 = Array_0(this.columns_0);
    var tmp$_4;
    ...
    tmp$_3[0] = array_1;
    var tmp$_5 = this.matrix_0;
    var array_2 = Array_0(this.columns_0);
    var tmp$_6;
    tmp$_6 = array_2.length - 1 | 0;
    for (var i_2 = 0; i_2 <= tmp$_6; i_2++) {
      array_2[i_2] = 4;
    }
    tmp$_5[this.rows_0 - 1 | 0] = array_2;
    tmp$_1 = this.rows_0 - 1 | 0;
    for (var i_3 = 1; i_3 < tmp$_1; i_3++) {
      tmp$_2 = this.columns_0;
      for (var j = 0; j < tmp$_2; j++) {
        if (j === 0 || j === (this.columns_0 - 1 | 0))
          this.matrix_0[i_3][j] = 4;
        else {
          if (this.maze_0.getVertexByCoordinate_vux9f0$(this.maze_0.getTopLeftVertex().X + j - 1 | 0, this.maze_0.getTopLeftVertex().Y - i_3 + 1 | 0).color === 4)
            this.matrix_0[i_3][j] = 4;
        }
      }
    }
    this.printMetadata_0(this.metadata_0);
    this.printMatrix_0(this.matrix_0);
  }
  ChessMazeMatrix.prototype.printMatrix_0 = function (m) {
    var tmp$, tmp$_0;
    for (tmp$ = 0; tmp$ !== m.length; ++tmp$) {
      var row = m[tmp$];
      for (tmp$_0 = 0; tmp$_0 !== row.length; ++tmp$_0) {
        var elem = row[tmp$_0];
        print(elem.toString() + ' ');
      }
      println();
  ...
  ChessMazeMatrix.prototype.printMetadata_0 = function (m) {
    var tmp$;
    ...
    while (tmp$.hasNext()) {
      ...
      println_0(key + ' -> ' + value.toString());
    }
  };
  ChessMazeMatrix.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ChessMazeMatrix',
    interfaces: []
  };
  ...
  Object.defineProperty(Scene.prototype, 'h', {
    configurable: true,
    get: function () {
  ...
  SceneController$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: []
  };
  ...
  Object.defineProperty(SceneController.prototype, 'h', {
    configurable: true,
    get: function () {
  ...
  Object.defineProperty(SceneController.prototype, 'scene', {
    configurable: true,
    get: function () {
  ...
  BulldozerTool.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'BulldozerTool',
    interfaces: []
  };
  ...
  LineToolHandler.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'LineToolHandler',
    interfaces: []
  };
  function LoadTool() {
  ...
  ToolController$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: []
  };
  ...
  ToolController.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ToolController',
    interfaces: []
  };
  function UndoTool() {
  ...
  Object.defineProperty(SceneRender.prototype, 'h', {
    configurable: true,
    get: function () {
  ...
  SceneRender.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'SceneRender',
    interfaces: [BaseRender]
  };
  ...
  package$automaton.AutomatonBuildException = AutomatonBuildException;
  package$automaton.AutomatonContext = AutomatonContext;
  package$automaton.AutomatonContextHolder = AutomatonContextHolder;
  package$automaton.AutomatonContextManager = AutomatonContextManager;
  Object.defineProperty(AutomatonRepository, 'Companion', {
    get: AutomatonRepository$Companion_getInstance
  });
  ...
  Object.defineProperty(_, 'lines', {
    get: function () {
      return lines;
    }
  });
  Object.defineProperty(_, 'automatonRepository', {
    get: function () {
      return automatonRepository;
    }
  });
  Object.defineProperty(_, 'sceneController', {
    get: function () {
      return sceneController;
    }
  });
  Object.defineProperty(_, 'codeEditor', {
    get: function () {
      return codeEditor;
    }
  });
  ...
  var package$Constants = _.Constants || (_.Constants = {});
  Object.defineProperty(package$Constants, 'MAX_COLOR_ID', {
    get: function () {
      return MAX_COLOR_ID;
    }
  });
  Object.defineProperty(package$Constants, 'WALL_COLOR_ID', {
    get: function () {
      return WALL_COLOR_ID;
    }
  });
  Object.defineProperty(package$Constants, 'NO_COLOR_ID', {
    get: function () {
      return NO_COLOR_ID;
    }
  });
  Object.defineProperty(package$Constants, 'LAMBDA_SYMBOL', {
    get: function () {
      return LAMBDA_SYMBOL;
    }
  });
  Object.defineProperty(package$Constants, 'CHESS_MAZE_MAX_Y', {
    get: function () {
      return CHESS_MAZE_MAX_Y;
    }
  });
  Object.defineProperty(package$Constants, 'CHESS_MAZE_MAX_X', {
    get: function () {
      return CHESS_MAZE_MAX_X;
    }
  });
  Object.defineProperty(package$Constants, 'STATE_DEFAULT_NAME', {
    get: function () {
      return STATE_DEFAULT_NAME;
    }
  });
  Object.defineProperty(package$Constants, 'DEFAULT_INIT_VERTEX_X', {
    get: function () {
      return DEFAULT_INIT_VERTEX_X;
    }
  });
  Object.defineProperty(package$Constants, 'DEFAULT_INIT_VERTEX_Y', {
    get: function () {
      return DEFAULT_INIT_VERTEX_Y;
    }
  });
  Object.defineProperty(package$Constants, 'DEFAULT_INITIAL_VERTEX', {
    get: function () {
      return DEFAULT_INITIAL_VERTEX;
    }
  });
  var package$editor = _.editor || (_.editor = {});
  package$editor.Editor = Editor;
  var package$handler = _.handler || (_.handler = {});
  var package$mouse = package$handler.mouse || (package$handler.mouse = {});
  package$mouse.BaseMouseEventHandler = BaseMouseEventHandler;
  package$mouse.Handler = Handler;
  package$mouse.MoveTool = MoveTool;
  ...
  package$core.ChessMazeBorder_init_qt1dr2$ = ChessMazeBorder_init_1;
  ...
  package$core.ChessMazeVertex_init = ChessMazeVertex_init_1;
  ...
  Object.defineProperty(ChessMazeEditorCore, 'Companion', {
    get: ChessMazeEditorCore$Companion_getInstance
  });
  package$generators.ChessMazeEditorCore = ChessMazeEditorCore;
  Object.defineProperty(ChessMazeGenerator, 'Companion', {
    get: ChessMazeGenerator$Companion_getInstance
  });
  package$generators.ChessMazeGenerator = ChessMazeGenerator;
  Object.defineProperty(ChessMazeManager, 'Companion', {
    get: ChessMazeManager$Companion_getInstance
  });
  var package$manager = package$maze.manager || (package$maze.manager = {});
  package$manager.ChessMazeManager = ChessMazeManager;
  package$manager.ChessMazeMatrix = ChessMazeMatrix;
  ...
  Object.defineProperty(SceneController, 'Companion', {
    get: SceneController$Companion_getInstance
  });
  ...
  Object.defineProperty(OutputTool, 'Companion', {
    get: OutputTool$Companion_getInstance
  });
  ...
  Object.defineProperty(ToolController, 'Companion', {
    get: ToolController$Companion_getInstance
  });
  ...
  main();
  Kotlin.defineModule('mazewalker', _);
  return _;
}));
